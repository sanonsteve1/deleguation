            ...
            >
                ...
                <ng-template #body let-product>
                    <tr>
                        ...
                        <td>
                            <img [src]="'/images/product/' + product.image" [alt]="product.name" style="width: 64px" class="rounded" />
                        </td>
        ...
        <p-dialog [(visible)]="productDialog" [style]="{ width: '450px' }" header="Product Details" [modal]="true">
            <ng-template #content>
                <div class="flex flex-col gap-6">
                    <img [src]="'/images/product/' + product.image" [alt]="product.image" class="block m-auto pb-6" *ngIf="product.image" />
                    <div>
