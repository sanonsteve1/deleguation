        ...
        <div class="col-span-full lg:col-span-6">
            <div class="card">
                ...
                <div class="card flex flex-col gap-6 items-center justify-center">
                    <p-toast />
                    <p-fileupload #fu mode="basic" chooseLabel="Choose" chooseIcon="pi pi-upload" name="demo[]" accept="image/*" maxFileSize="1000000" (onUpload)="onBasicUpload()" url="https://www.primefaces.org/cdn/api/upload.php" />
