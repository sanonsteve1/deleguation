            ...
            <div class="md:w-1/2">
                ...
                <div class="card">
                    ...
                    <p-avatar-group class="mb-4">
                        <p-avatar image="/images/avatar/amyelsner.png" size="large" shape="circle"></p-avatar>
                        <p-avatar image="/images/avatar/asiyajavayant.png" size="large" shape="circle"></p-avatar>
                        <p-avatar image="/images/avatar/onyamalimba.png" size="large" shape="circle"></p-avatar>
                        <p-avatar image="/images/avatar/ionibowcher.png" size="large" shape="circle"></p-avatar>
                        <p-avatar image="/images/avatar/xuxuefeng.png" size="large" shape="circle"></p-avatar>
                        <p-avatar
                            label="+2"
                            shape="circle"
                            size="large"
                ...
                <div class="card">
                    ...
                    <div class="flex items-center flex-col sm:flex-row gap-2">
                        <p-chip label="Amy Elsner">
                            <img src="/images/avatar/amyelsner.png" class="w-8 h-8" alt="avatar" />
                        </p-chip>
                        <p-chip label="Asiya Javayant">
                            <img src="/images/avatar/asiyajavayant.png" class="w-8 h-8" alt="avatar" />
                        </p-chip>
                        <p-chip label="Onyama Limba">
                            <img src="/images/avatar/onyamalimba.png" class="w-8 h-8" alt="avatar" />
                        </p-chip>
                        <p-chip label="Xuxue Feng" [removable]="true">
                            <img src="/images/avatar/xuxuefeng.png" class="w-8 h-8" alt="avatar" />
                        </p-chip>
                    </div>
                </div>
