                ...
                <div class="col-span-12 lg:col-span-7">
                    <div class="flex">
                        <div class="flex flex-col w-2/12 justify-between" style="row-gap: 1rem;">
                            <img
                                *ngFor="let image of images; let i = index"
                                ...
                                src="/images/ecommerce/productoverview/{{ image }}"
                        ...
                        <div class="pl-4 w-10/12 flex">
                            <img src="/images/ecommerce/productoverview/{{ images[selectedImageIndex] }}" class="w-full border-2 border-transparent rounded" />
                        </div>
                    </div>
                </div>
                <div class="col-span-12 lg:col-span-4 py-4 lg:pl-12">
                    ...
                    <div class="flex items-center mb-8">
                        <div
                            ...
                            [style.box-shadow]="color() === 'bluegray' ? '0 0 0 0.2rem var(--p-slate-500)' : null"
                            (click)="changeColor('bluegray')"
                        ></div>
                        <div
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center flex-1 mt-4 sm:mt-0 ml-0 sm:ml-8">
                            <button pButton pRipple label="Add to Cart" class="flex-1 mr-8"></button>
                            <i
