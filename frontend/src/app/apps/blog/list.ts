            ...
            <div class="bg-surface-0 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20">
                ...
                <div class="grid grid-cols-12 gap-4 nogutter">
                    <div class="col-span-12 lg:col-span-4 p-6">
                        ...
                        <div class="flex mt-6">
                            <p-avatar image="/images/avatar/circle/avatar-f-1.png" shape="circle"></p-avatar>
                            <div class="ml-2">
                    ...
                    <div class="col-span-12 lg:col-span-4 p-6">
                        ...
                        <div class="font-sm text-surface-700 dark:text-surface-100 leading-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                        <div class="flex mt-6">
                            <p-avatar image="/images/avatar/circle/avatar-f-2.png" shape="circle"></p-avatar>
                            <div class="ml-2">
                    ...
                    <div class="col-span-12 lg:col-span-4 p-6">
                        ...
                        <div class="font-sm text-surface-700 dark:text-surface-100 leading-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                        <div class="flex mt-6">
                            <p-avatar image="/images/avatar/circle/avatar-f-3.png" shape="circle"></p-avatar>
                            <div class="ml-2">
