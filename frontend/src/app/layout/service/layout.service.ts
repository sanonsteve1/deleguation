...
export class LayoutService {
    ...
    onMenuToggle() {
        if (this.isOverlay()) {
            this.layoutState.update((prev: LayoutState) => ({ ...prev, overlayMenuActive: !this.layoutState().overlayMenuActive }));
        ...
        if (this.isDesktop()) {
            this.layoutState.update((prev: LayoutState) => ({ ...prev, staticMenuDesktopInactive: !this.layoutState().staticMenuDesktopInactive }));
        } else {
            this.layoutState.update((prev: LayoutState) => ({ ...prev, staticMenuMobileActive: !this.layoutState().staticMenuMobileActive }));
    ...
    onMenuProfileToggle() {
        this.layoutState.update((prev: LayoutState) => ({ ...prev, menuProfileActive: !prev.menuProfileActive }));
    }

    openRightMenu() {
        this.layoutState.update((prev: LayoutState) => ({ ...prev, rightMenuActive: true }));
    }
    ...
    hideConfigSidebar() {
        this.layoutState.update((prev: LayoutState) => ({ ...prev, configSidebarVisible: false }));
    }
}
